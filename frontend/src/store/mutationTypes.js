...
export const FETCH_COST_YEARS_START = "FETCH_COST_YEARS_START";
export const FETCH_COST_YEARS_SUCCESS = "FETCH_COST_YEARS_SUCCESS";
export const FETCH_COST_YEARS_ERROR = "FETCH_COST_YEARS_ERROR";
